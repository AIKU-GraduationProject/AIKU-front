...
f = open('./ChatBot_DataSet/ChatbotData.csv', 'r', encoding='utf-8')
rdr = csv.reader(f)
cq = []
ca = []
...
df = pd.read_excel('./ChatBot_DataSet/data.xlsx')
cq_1 = []
ca_1 = []
...
file = open("./ChatBot_DataSet/KETI_Data.txt", 'r')
...
np.save('./ChatBot_numpy_model', dataset_cls_hidden) # x_save.npy
...
print(chatbot_Answer[l[-1]])
print(chatbot_Answer[l[-2]])
print(chatbot_Answer[l[-3]])
